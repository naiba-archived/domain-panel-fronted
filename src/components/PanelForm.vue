<template>
  <el-form :status-icon="true" ref="form" :rules="rules" :model="form" label-width="80px">
    <el-form-item label="标题·中" prop="name_cn">
      <el-input v-model="form.name_cn" placeholder="日落域名资产管理平台"></el-input>
    </el-form-item>
    ...
    <el-form-item label="简介·中" prop="desc_cn">
      <el-input type="textarea" :rows="3" v-model="form.desc_cn" placeholder="日落域名资产管理平台（riluo.cn）是由资深域名投资人奶爸创建，前身是09年上线的知名域名平台泡名网，后因业务整合，于2013年9月1号将泡名网业务全部转移到日落域名资产管理平台（riluo.cn）上。"></el-input>
    </el-form-item>
